...
textExpander1.addEventListener("click", function() {
    if (expandableText1.classList.contains("faqp1")) expandableText1.classList.replace("faqp1", "faqpV");
    else expandableText1.classList.replace("faqpV", "faqp1");
});
textExpander2.addEventListener("click", function() {
    if (expandableText2.classList.contains("faqp2")) expandableText2.classList.replace("faqp2", "faqpV");
    else expandableText2.classList.replace("faqpV", "faqp2");
});
textExpander3.addEventListener("click", function() {
    if (expandableText3.classList.contains("faqp3")) expandableText3.classList.replace("faqp3", "faqpV");
    else expandableText3.classList.replace("faqpV", "faqp3");
});
